...
placing_order_clean = ["UCCTent",  "CommunityTent", "MedicalTent", "MessTent", "RestTent", "K9Tent"]
...
if __name__ == '__main__':
    ...
    mapy = maps.Map(50,50, tents_requested, entrance_xy, xy_out_of_bounds, placing_order=placing_order)

    print(mapy.CSP().matrix)
